          ...
          {Object.entries(createdByGroups).map(([createdBy, leads]) => {
            ...
            return (
              <div key={createdBy} className="ml-4 mb-4">
                ...
                >
                  {/* SVG Divider - adjusted left position */}
                  <div
                    className={`${
                      !isConfirmationDialogueOpened && "absolute"
                    } left-[85px] top-0 h-full w-[132px] -translate-x-1/2`}
                    style={{ zIndex: isConfirmationDialogueOpened ? -1 : 0 }}
                  >
                    <svg
                      width="132"
                  ...
                  {/* Left section with adjusted spacing */}
                  <div
                    className="relative flex flex-col items-start rounded-tr-2xl pr-3 min-w-[90px]"
                    style={{
                      zIndex: fromTable
                  ...
                  >
                    {/* Employee name with proper spacing */}
                    <div
                      className={`h-[18px] w-max px-2.5 min-w-[30px] rounded-[30px] border ${
