...
const ProfileIcon = ({ className, onClick }) => {
  ...
  return (
    <div className={`${!isConfirmationDialogueOpened && "relative"} flex justify-center items-center`}>
      <div className="relative group">
        ...
        {/* Tooltip positioned relative to the SVG */}
        <div className="absolute top-full left-1/2 transform -translate-x-1/2 mt-4 px-2 py-1 bg-[#EBEBEB] text-[#214768] text-xs rounded opacity-0 group-hover:opacity-100 transition-opacity duration-200 whitespace-nowrap z-50 pointer-events-none">
          Profile
