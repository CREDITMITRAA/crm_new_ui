...
const NotificationIcon = ({ className }) => {
  ...
  return (
    <div className={`${!isConfirmationDialogueOpened && "relative"} group`}>
      ...
      <div className="absolute top-full left-1/2 transform -translate-x-[50%] mt-4 px-2 py-1 bg-[#EBEBEB] text-[#214768] text-xs rounded opacity-0 group-hover:opacity-100 transition-opacity duration-200 whitespace-nowrap z-50">
        {"Notification"}
