...
function UpdateVerificationStatusDialogue({
  onClose,
  setOpenToast,
  openToast,
  payload = null,
  ...
  const [verificationStatusNote, setVerificationStatusNote] = useState("");
    ...
    if (payload.verification_status === REJECTED) {
      if (!rejectionReason.trim()) {
        ...
        try {
          ...
          dispatch(updateVerificationStatus(apiPayload));
        } catch (error) {
      ...
      let apiPayload = {
        ...payload,
        verification_status_note: verificationStatusNote,
      };
      try {
        dispatch(updateVerificationStatus(apiPayload));
      } catch (error) {
  ...
  function handleChange(e) {
    setVerificationStatusNote(e.target.value);
  }
...
export default UpdateVerificationStatusDialogue;
